...
var about = [
	['NAME:','PRINCE ARCE'],
	['PROFILE:','PHP DEVELOPER | PROJECT MANAGER'],
	['EMAIL:','PRINCE_ARCE01@OUTLOOK.COM'],
	['EDUCATION:','BS INFORMATION TECHNOLOGY'],
	['INDUSTRY KNOWLEDGE:','<br>IT OPERATIONS, COMPUTER HARDWARE INSTALLATION, WINDOWS AND LINUX OS, SERVER MANAGEMENT, COMPUTER NETWORKS, BASIC CLOUD OPERATION, IT DOCUMENTATION, SCRIPTING AND PROGRAMMING, DATA AND DATABASE MANAGEMENT, DATA SECURITY FUNDAMENTALS, PROJECT MANAGEMENT, EXECUTIVE REPORTING']
];
