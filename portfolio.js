...
var about = [
	['NAME:','PRINCE ARCE'],
	['PROFILE:','PROGRAMMER | IT CONSULTANT'],
	['EMAIL:','PRINCE_ARCE01@OUTLOOK.COM'],
	['EDUCATION:','BS INFORMATION TECHNOLOGY'],
	['INDUSTRY KNOWLEDGE:','<br>IT OPERATIONS, COMPUTER HARDWARE INSTALLATION, WINDOWS AND LINUX SUPPORT, SERVER MANAGEMENT, CABLE MANAGEMENT, COMPUTER NETWORKS, BASIC CLOUD OPERATION, IT DOCUMENTATION, SCRIPTING AND PROGRAMMING, DATA AND DATABASE MANAGEMENT, DATA SECURITY FUNDAMENTALS, PROJECT MANAGEMENT, EXECUTIVE REPORTING, ARTIFICIAL INTELLIGENCE, PREDICTIVE MODELING, EMAIL MARKETING AUTOMATION, PROMPT ENGINEERING, TECH SUPPORT']
];
