...
// TYPEWRITER EFFECT
let i = 0;
const txt = 'PROGRAMMER | IT SPECIALIST| DATA SCIENCE PRACTITIONER | ENTREPRENEUR';
const speed = 15;
...
const get_theme = () => {
    ...
    if (theme === 'dark') {
        ...
        $('nav').addClass('white').removeClass('#212121 grey darken-4');
        ...
        $('#title').addClass('grey-text text-darken-3 lighten-3').removeClass('white-text');
